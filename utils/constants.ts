...
export const ENV_CONFIG = {
  DEVELOPMENT: {
    API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://employee-insights-api.adityalasika.workers.dev',
    ENABLE_LOGGING: true,
    ENABLE_DEBUG: true,
  },
  STAGING: {
    API_BASE_URL: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://staging-api.example.com',
    ENABLE_LOGGING: true,
    ENABLE_DEBUG: false,
  },
  PRODUCTION: {
