...
// Type Guards
export const isApiError = (error: any): error is import('./api').ApiError => {
  return error && typeof error.message === 'string';
};

export const isAuthError = (error: any): error is import('./auth').AuthError => {
  return error && typeof error.code === 'string' && typeof error.message === 'string';
};

export const isSentimentType = (value: any): value is import('./common').SentimentType => {
  return ['positive', 'negative', 'neutral'].includes(value);
};

export const isValidStatus = (value: any): value is import('./common').Status => {
...
export interface AppContextType {
  ...
  theme: import('./common').ThemeMode;
  config: import('./common').AppConfig;
  setTheme: (theme: import('./common').ThemeMode) => void;
  updateConfig: (config: Partial<import('./common').AppConfig>) => void;
}
...
export interface AppStore {
  ...
  insights: {
    data: import('./components').InsightData[];
    filters: import('./insights').InsightFilters;
    loading: boolean;
    error: string | null;
  };
  ui: {
    ...
    theme: import('./common').ThemeMode;
    notifications: import('./common').ToastMessage[];
  };
}
...
export type AppAction =
  ...
  | { type: 'SET_INSIGHTS'; payload: import('./components').InsightData[] }
  | { type: 'SET_FILTERS'; payload: import('./insights').InsightFilters }
  | { type: 'SET_LOADING'; payload: boolean }
  | { type: 'SET_ERROR'; payload: string | null }
  | { type: 'TOGGLE_SIDEBAR' }
  | { type: 'SET_THEME'; payload: import('./common').ThemeMode }
  | { type: 'ADD_NOTIFICATION'; payload: import('./common').ToastMessage }
