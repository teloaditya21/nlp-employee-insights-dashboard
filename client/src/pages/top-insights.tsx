...
import AmChartsWordCloud from "@/components/dashboard/amcharts-word-cloud";
        ...
        <div className="bg-white rounded-[12px] p-4 mb-6 shadow-[0_10px_20px_rgba(0,0,0,0.05)]">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="relative">
              <Select value={selectedKota} onValueChange={handleKotaChange}>
            ...
            <div className="mt-3 text-sm text-gray-600">
              {insightsData?.total > 0 ? (
                <span className="text-green-600">
                  ✓ Ditemukan {insightsData.total} insights untuk "{searchTerm}"
                </span>
              ) : (
